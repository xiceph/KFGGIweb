        ...
        <div>
          ...
          <div className="divide-y divide-k-xl-gray">
            <div className="py-4 first:pt-0">
              ...
              <div className="mb-1.5"><Datum date={ new Date("2023-03-29") } today={ new Date(props.today) }></Datum></div>
               <h5 className="font-bold mb-2">Prednáška</h5>
               <p className="font-bold mb-f1">Fenomény krasu Malých Karpát</p>
               ...
               <div>
                 ...
                 <div className="mb-2">Prednášajúci: <i>RNDr. Alexander Lačný, PhD.</i></div>
                 <div className="mb-2">Pripojte sa na: <a href="https://lnk.sk/ogms" target="_blank">https://lnk.sk/ogms</a></div>
                 <div className="mb-8"><a href="https://fns.uniba.sk/fileadmin/prif/kalendar/2023/2023-03-29-geovedy.jpg" target="_blank">Plagát</a></div>
               </div>
