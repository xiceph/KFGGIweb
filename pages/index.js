        ...
        <div>
          ...
          <div className="divide-y divide-k-xl-gray">
            <div className="py-4 first:pt-0">
              ...
              <div className="mb-1.5"><Datum date={ new Date("2025-02-19") } today={ new Date(props.today) }></Datum></div>
              <h5 className="font-bold mb-2">Prednáška</h5>
              <p className="font-bold mb-f1">Platňová tektonika - história významnej myšlienky 20. storočia </p>
              <div>
                <div className="mb-2">Čas: 15:00 – 17:00 <br/><i>online cez MS Teams</i>, <i>prezenčne na PriF UK, B1-PLUS</i> </div>
                <div className="mb-2">Prednášajúci: <i>doc. RNDr. Rastislav Vojtko, PhD.</i></div>
                <div className="mb-2">Pripojte sa na: <a href="https://lnk.sk/qsm9" target="_blank">https://lnk.sk/qsm9</a></div>
                <div className="mb-8"><a href="https://fns.uniba.sk/fileadmin/prif/kalendar/2025/2025-02-19-geovedy.jpg" target="_blank">Plagát</a></div>
              </div>
