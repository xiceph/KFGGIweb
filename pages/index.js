        ...
        <div>
          ...
          <div className="divide-y divide-k-xl-gray">
            <div className="py-4 first:pt-0">
              ...
              {/*<div className="mb-1.5"><Datum date={ new Date("2023-10-25") } today={ new Date(props.today) }></Datum></div>
                <h5 className="font-bold mb-2">Prednáška</h5>
                <p className="font-bold mb-f1">Železničné prevádzky – špecifický typ environmentálnych záťaží</p>
              ...
              <div>
                ...
                <div className="mb-2">Prednášajúci: <i>Mgr. Juraj Macek, PhD. </i></div>
                <div className="mb-2">Pripojte sa na: <a href="https://lnk.sk/qdx3" target="_blank">https://lnk.sk/qdx3</a></div>
                <div className="mb-8"><a href="https://fns.uniba.sk/uploads/pics/2023-10-25-geovedy.jpg" target="_blank">Plagát</a></div>
              </div>
