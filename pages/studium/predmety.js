...
//   }) 
  ...
  return (
    <div className="w-full">
      ...
      <p><a href="docs/predmetyMgr.pdf" target="_blank">Zoznam predmetov</a> študijného programu fyzická geografia a geoinformatika</p>
      
      <h2>Predmety doktorandského štúdia</h2>
      <p><a href="docs/predmetyPhD.pdf" target="_blank">Zoznam predmetov</a> študijného programu fyzická geografia, geoekológia a geoinformatika</p>
    </div>
  )
}
