...
export default function Programy() {
  return (
    <section>
      ...
      <Contents levels={1} >
        <h3>Bakalárske programy</h3>
        <div className="font-bold mt-s4 text-lg">3 ročné štúdium</div>
        <p>Hlavnou devízou geografa je schopnosť riešiť problémy v priestorových súvislostiach a s celostným pohľadom na vzťahy medzi zložkami prírody a ľudskej spoločnosti. Ponúkame dva bakalárske študijné programy, ktoré našich absolventov učia tieto nástroje intuitívne používať pri riešení stále častejších interdisciplinárnych výziev v oblastiach prírodných vied, ale aj za ich hranicami. Oba programy majú spoločný geograficko – kartografický základ a líšia sa len menšou časťou predmetov, ich hlavný rozdiel je v dôraze: Kým jeden je silnejšie zameraný na pochopenie prírodných javov a ich vzájomných vzťahov, druhý akcentuje čím hlbšie pochopenie práce s geografickými informáciami - geoinformatiku.</p>
        <h4>Geografia, kartografia a geoinformatika</h4>
        <p>Program je zameraný na kartografiu a prácu s geografickými informačnými systémami (GIS), no pozornosť je taktiež venovaná problematike diaľkového prieskumu Zeme a databázového modelovania. Absolventi si osvoja metódy kartografického modelovania geografickej informácie, učia sa navrhovať a vyhodnocovať vlastnosti kartografických zobrazení a získavajú rozsiahle praktické zručnosti pri tvorbe tematických máp a základných geografických webových aplikácií. V oblasti GIS-ov je okrem rozsiahlej praxe podstatné aj nadobudnutie teoretických vedomostí o pozadí ich fungovania, bez ktorých im nie je možné skutočne porozumieť a ktoré sú preto predpokladom ich expertného používania. Samotná prax zahŕňa prácu s databázovými nástrojmi, ovládanie digitálnych metód zberu geografických informácií a ich následnú integráciu v geografickej báze údajov, ale aj modelovanie ich priestorových vzťahov, ktoré je zásadnou pridanou hodnotou GIS-ov. Uplatniteľnosť absolventov je vysoká, keďže dopyt po geoinformatických riešeniach rastie v súkromnej aj verejnej sfére: Jedná sa predovšetkým o pozície GIS analytika, dátového analytika či databázového špecialistu, a to jednak v expertných firmách, jednak vo verejnej správe (štátnej, regionálnej aj komunálnej), či v odborných a výskumných inštitúciách.</p>
        <h4>Geografia a geoekológia pre krajinné plánovanie</h4>
        <p>Tento program je zameraný na štúdium vzťahov medzi zložkami prírody, od geologického podložia a tvarov reliéfu cez pôdy, vodstvo, klímu až po rastlinné a živočíšne spoločenstvá. Odhaľuje procesy, ktoré sa v nich a medzi nimi odohrávajú, hodnotí ich vplyv na ľudskú činnosť, ale aj naopak - vplyv ľudskej činnosti na ne. Absolventi dokážu v tejto oblasti vnímať a riešiť problémy v priestorových súvislostiach a hodnotiť ich z rôznych uhlov pohľadu, keďže dokážu spájať informácie z mnohých prírodovedných odborov. Orientujú sa aj v súvisiacich technických disciplínach, v ochrane prírody, krajinnom plánovaní a v základoch environmentálnej legislatívy. Vďaka tomu dokážu spolupracovať s množstvom špecialistov a riešiť komplexné problémy, ako napríklad zosúlaďovanie ochrany prírody a krajiny s jej využívaním. Majú tiež prax s prácou v teréne aj s GIS analýzami a digitálnou tvorbou máp a preto sú univerzálne uplatniteľní v oblastiach životného prostredia, pôdohospodárstva a prakticky v akomkoľvek sektore, ktorý vyžaduje priestorové a syntetické myslenie a prax s GIS</p>
        <h3>Magisterský program</h3>
        <div className="font-bold mt-s4 text-lg">2 ročné štúdium</div>
        ...
        <p><b>Fyzickogeografické predmety</b> prechádzajú od štúdia zložiek prírodnej krajiny k štúdiu metód ich výskumu. Prednášky predstavujú teoretické princípy širokej palety terénnych, laboratórnych aj GIS výskumných postupov, pričom tie najpodstatnejšie sú prakticky realizované v rámci rozsiahlych cvičení. Týmto študentov pripravujeme na prácu v interdisciplinárnych tímoch, ktoré riešia komplexné a stále pribúdajúce problémy životného prostredia a k tomu nevyhnutné postupy ako hodnotenie a monitoring prírodnej krajiny, územné a krajinné plánovanie, či postupy pre trvalo udržateľný rozvoj.</p>
        ...
        <a href="https://www.uplatnenie.sk/?degree=V%C5%A0&vs=701000000&faculty=701040000&field=1316T41&year=2019" target="_blank">Uplatnenie absolventov z roku 2019</a><br/>
        <a href="https://www.uplatnenie.sk/?degree=V%C5%A0&vs=701000000&faculty=701040000&field=1316T41&year=2018" target="_blank">Uplatnenie absolventov z roku 2018</a><br/>
        </p>
        <h3>Doktorandský program</h3>
        <div className="font-bold mt-s4 text-lg">4 ročné interné štúdium / 5 ročné externé štúdium</div>
