...
export default function Programy() {
  return (
    <section>
      ...
      <Contents levels={1} >
        <h3 className="border-l-3 md:border-l-4 border-k-brown pl-3 md:pl-5 pt-2 md:pt-3 pb-1">Bakalárske programy</h3>
