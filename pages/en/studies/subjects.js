...
//   }) 
  ...
  return (
    <div className="w-full">
      ...
      <p><a href="/docs/predmetyMgr.pdf" target="_blank">List of the subjects</a> on the study programme "Physical Geography and Geoinformatics"</p>
      
      <h2>Subjects of the Doctoral study programme</h2>
      <p><a href="/docs/predmetyPhD.pdf" target="_blank">List of the subjects</a> on the study programme "Physical Geography, Geoecology, and Geoinformatics"</p>
    </div>
  )
}
