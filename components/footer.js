export default function Footer( props ) {
  ...
  return (
    <footer className="max-w-screen-xl w-full mx-auto border-t border-gray-200 text-gray-700 px-6 py-10 grid md:grid-cols-2 gap-6 text-sm md:text-base">
      <div>
